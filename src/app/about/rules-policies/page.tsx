...
const documents = [
  ...
  },
  {
    ...
    description:
      'Consent for photo and video use from USAIC events, including promotional and social media use.',
  },
  {
    icon: ShieldCheck,
      ...
      <section className="section-padding">
        <div className="section-container">
          ...
          <p className="text-slate-500 text-sm text-center max-w-2xl mx-auto mt-10">
            These documents are being finalized and will be posted here — check back before
