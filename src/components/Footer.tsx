...
const socialLinks = [
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/usaiceclimbing',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'YouTube',
    href: 'https://youtube.com/@usaiceclimbing',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 bg-ice-600 rounded-lg flex items-center justify-center">
                <span className="text-white font-display text-lg">US</span>
              </div>
              <span className="font-display text-xl">USA Ice Climbing</span>
            </Link>
          ...
          {/* Organization Links */}
          <div>
            <h3 className="font-display text-lg mb-4">Organization</h3>
            <ul className="space-y-2">
        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-500 text-sm">
              © {new Date().getFullYear()} USA Ice Climbing. All rights reserved.
            </p>
